...
;
create_scope: CREATE SCOPE named_scope_ref if_not_exists?
;
drop_scope: DROP SCOPE named_scope_ref if_exists?
;
create_collection: CREATE COLLECTION named_keyspace_ref if_not_exists?
;
drop_collection: DROP COLLECTION named_keyspace_ref if_exists?
;
...
flush_or_truncate: FLUSH
	| TRUNCATE
;
create_index: CREATE INDEX index_name ON named_keyspace_ref LPAREN index_terms RPAREN index_partition index_where opt_index_using opt_index_with if_not_exists?
;

create_primary_index: CREATE PRIMARY INDEX opt_primary_name ON named_keyspace_ref index_partition opt_index_using opt_index_with if_not_exists?
;
opt_primary_name: 
	| index_name
;
